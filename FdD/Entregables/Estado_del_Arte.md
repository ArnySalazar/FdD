...
El estudio realizado en el distrito de Chiclayo, Lambayeque, Perú, desarrolló un planificador de rutas utilizando el algoritmo de Dijkstra para optimizar la recolección de desechos sólidos. Se implementó sobre un sistema informático que utilizaba un grafo dirigido ponderado y la API de Google Maps para visualizar y planificar las rutas. Los resultados mostraron mejoras en el tiempo promedio de ejecución del algoritmo, especialmente cuando se manejan más de 20 puntos de recolección, indicando una optimización eficaz en las rutas de recolección. [[2]](https://ieeexplore.ieee.org/document/9274699).
